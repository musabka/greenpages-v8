...
import { useCreateCity, useGovernorates } from '@/lib/hooks';
...
export default function NewCityPage() {
  ...
  useEffect(() => {
    if (initialGovernorateId && !governorateId) {
      setGovernorateId(initialGovernorateId);
    }
  ...
  const isSaving = createCity.isPending;
  const canSave = !!governorateId && !!nameAr.trim() && !isSaving;
    ...
    <div>
      ...
      <div className="page-header">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="page-title">إضافة مدينة</h1>
            <p className="text-gray-500 mt-1">أضف مدينة جديدة</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2">
          <div className="card">
            <div className="card-header">
              <h2 className="font-bold text-gray-900">معلومات المدينة</h2>
            </div>
