...
export function useAgentProfile() {
  return useQuery({
    ...
    queryFn: () => agentPortalApi.getProfile().then(res => res.data),
  });
}
...
export function useAgentDashboard() {
  return useQuery({
    ...
    queryFn: () => agentPortalApi.getDashboard().then(res => res.data),
  });
}
...
export function useGovernorates(params?: { limit?: number }) {
  return useQuery({
    ...
    queryFn: () => governorateApi.getAll(params).then(res => res.data),
  });
}
...
export function useCities(governorateId?: string) {
  return useQuery({
    ...
    queryFn: () => cityApi.getAll(governorateId).then(res => res.data),
  });
}
...
export function useDistricts(cityId?: string) {
  return useQuery({
    ...
    queryFn: () => districtApi.getAll(cityId).then(res => res.data),
  });
}
